...
{
    public abstract class M1_ICharactersController : MonoBehaviour, M1_ICharacterItem
    {
        ...
        public virtual void Movement()
        {
            ...
            {
                if (!M1_PlayerSoundManager.instance.audioSource.isPlaying)
                {
                    M1_PlayerSoundManager.instance.PlayFootstepSound();
                }
                charSpeed -= 0.01f;
            }
        ...
        public virtual void GroundCheck()
        {
            ...
            if (!IsGrounded)
            {
                M1_PlayerSoundManager.instance.StopSound();
            }
        }
