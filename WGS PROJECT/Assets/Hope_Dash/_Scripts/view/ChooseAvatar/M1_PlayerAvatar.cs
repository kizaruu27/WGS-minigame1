...
{
    public class M1_PlayerAvatar : MonoBehaviourPunCallbacks
    {
        ...
        {
            M1_RoomManager.instance.DisplayAvaParent.SetActive(true);
            M1_RoomManager.instance.AvaToggleGroup.SetAllTogglesOff();
        }
        ...
        public void OnClickSetAvatarIndex()
        {
            ...
            M1_RoomManager.instance.DisplayAvaParent.SetActive(false);
        }
        ...
        public void PlayerReady()
        {
            ...
            if (PhotonNetwork.LocalPlayer.IsLocal)
                M1_RoomManager.instance.SetPlayerReady();
        }
