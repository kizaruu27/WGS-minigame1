...
{
    public class M1_GameplayLeaderboardManager : MonoBehaviourPunCallbacks
    {
        public static M1_GameplayLeaderboardManager instance;
        PhotonView PV;
        ...
        {
            M1_FinishLeaderboard m1FinishManager = GameObject.FindObjectOfType<M1_FinishLeaderboard>();
            m1FinishManager.TotalPlayersDisconnect = total;
        }
    }
